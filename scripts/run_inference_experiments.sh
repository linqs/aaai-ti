...
EXAMPLE_OPTIONS[entity-resolution]='-D sgd.learningrate=10'
EXAMPLE_OPTIONS[friendship-500M]='-D sgd.learningrate=0.1'
EXAMPLE_OPTIONS[friendship-1B]='-D sgd.learningrate=0.1'
