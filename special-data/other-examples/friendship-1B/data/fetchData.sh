...
readonly DATA_URL='https://linqs-data.soe.ucsc.edu/public/psl-infinite-experiments/friendship-1B.zip'
readonly DATA_FILE='friendship-1B.zip'
readonly DATA_DIR='friendship-1B'
