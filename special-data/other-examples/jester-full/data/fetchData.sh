...
readonly DATA_URL='https://linqs-data.soe.ucsc.edu/public/psl-infinite-experiments/jester-full.zip'
readonly DATA_FILE='jester-full.zip'
readonly DATA_DIR='jester-full'
