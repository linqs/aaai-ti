...
readonly DATA_URL='https://linqs-data.soe.ucsc.edu/public/psl-infinite-experiments/friendship-500M.zip'
readonly DATA_FILE='friendship-500M.zip'
readonly DATA_DIR='friendship-500M'
